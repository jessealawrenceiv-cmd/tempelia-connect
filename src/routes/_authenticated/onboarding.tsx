...
function OnboardingPage() {
  ...
  return (
    <div>
      <PageHeader eyebrow="Setup" title="Welcome to Temaro" />
      <div className="mx-auto max-w-2xl space-y-5 p-5 md:p-8">
        <div className="panel p-6">
          <div className="label-eyebrow">Step 1 · Dedicated number</div>
          <h2 className="mt-1 text-xl">Your Temaro line</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            We automatically buy a local Twilio number under Temaro's master account and wire it up
