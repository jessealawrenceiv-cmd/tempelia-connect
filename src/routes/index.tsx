...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Temaro — The quiet line that keeps your business booked" },
      { name: "description", content: "Temaro auto-texts missed calls, requests Google reviews, and re-engages dormant customers so your calendar stays full." },
      { property: "og:title", content: "Temaro — The quiet line that keeps your business booked" },
...
const features = [
  {
    ...
    body: "When a customer calls and you can't pick up, Temaro texts them back within 30 seconds from the same number. Most callers reply and book.",
  },
  {
    tag: "02 · Review Booster",
    title: "More reviews, more bookings.",
    body: "After every job, Temaro sends your customer a Google review link. More five-star reviews mean more calls and more appointments on the calendar.",
  },
  {
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 md:grid-cols-[1.3fr_1fr] md:py-24">
          <div>
            ...
            <p className="mt-6 max-w-lg text-base text-muted-foreground">
              Temaro runs behind your existing business line — auto-texting missed calls, asking
