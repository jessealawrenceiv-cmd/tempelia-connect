    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-2xl p-5 md:p-10">
        <header className="mb-6">
          ...
          <h1 className="font-display text-3xl md:text-4xl uppercase mt-1">{info?.businessName || "Temaro"}</h1>
        ...
        <form onSubmit={onSubmit} className="panel p-5 md:p-6 space-y-5">
          ...
          <label className="flex items-start gap-3 rounded-sm border border-border bg-background/40 p-3">
            ...
            <span className="text-xs leading-relaxed text-muted-foreground">
              By checking this box, you agree to receive recurring text messages from {businessLabel}, including replies to your inquiry, appointment updates, and review requests. Message frequency varies. Message and data rates may apply. Reply STOP to unsubscribe. Terms:{" "}
